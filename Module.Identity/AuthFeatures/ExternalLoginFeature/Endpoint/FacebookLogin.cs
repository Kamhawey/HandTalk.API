...
public class FacebookLogin : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        app.MapPost(IdentityEndpointConstants.Routes.FacebookLogin, 
                async (FacebookSignInCommand command, ISender sender) => await sender.Send(command))
            ...
            .WithSummary(nameof(FacebookLogin))
            .WithDescription("Sign in with Facebook");
    }
}
